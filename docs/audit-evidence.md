...
gate; the CI compatibility matrix runs `go test ./...` with Go 1.25 and stable
Go on Linux, macOS, and Windows.
...
| Formatting, API, safety, vet, race, fuzz, benchmark, docs, vulnerability, lint, and cross-platform compatibility gates exist | [`Makefile`](../Makefile), [`ci.yml`](../.github/workflows/ci.yml), [`security.yml`](../.github/workflows/security.yml), and the verification commands in [`hardening.md`](hardening.md). |
