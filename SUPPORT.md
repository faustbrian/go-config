...
Use [GitHub Issues](https://github.com/faustbrian/go-config/issues/new/choose)
...
Use [GitHub Discussions](https://github.com/faustbrian/go-config/discussions)
...
[`COMPATIBILITY.md`](COMPATIBILITY.md). The main branch is development state;
support claims apply after a module-specific release.
